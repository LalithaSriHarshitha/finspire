...
const heroImage = {
  ...
  alt: "Professional Indian businesswoman in office"
};
...
const testimonials = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1580518337843-f959e992563b?auto=format&fit=crop&w=400&q=80"
  },
  {
    name: "Neha Singh",
...
function LandingPage() {
  return (
    <div className="min-h-screen w-full bg-purple-200 text-gray-900 flex flex-col font-sans">
      {/* Navigation */}
      <nav className="bg-white/80 backdrop-blur sticky top-0 z-50 border-b border-purple-100 w-full">
        <div className="flex justify-between items-center px-4 py-3 w-full max-w-6xl mx-auto">
          <div className="flex items-center space-x-2">
            <span className="inline-block align-middle">
              <svg width="32" height="32" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="24" cy="24" r="24" fill="#C084FC" />
                <path d="M24 12L28 24H20L24 12Z" fill="white" />
                <circle cx="24" cy="32" r="4" fill="white" />
              </svg>
            </span>
            <h1 className="text-2xl font-bold text-purple-600 tracking-wide">FINSPIRE</h1>
          </div>
          <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-xl text-sm font-medium shadow transition-all">Get Started</button>
        </div>
      </nav>

      {/* Hero Section */}
      <section className="w-full py-10 sm:py-16 bg-purple-200 border-b border-purple-100">
        <div className="w-full max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-8 sm:gap-12 px-4 sm:px-6">
          <div className="flex-1 text-center md:text-left space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
              Your Confidence. Your Business. <span className="text-purple-500">FINSPIRE</span>
            </h1>
            ...
            <button className="mt-4 bg-purple-500 hover:bg-purple-600 text-white px-8 py-4 rounded-2xl text-base sm:text-lg font-semibold shadow-lg transition-all">Start Your Journey</button>
          </div>
      ...
      {/* Features Section */}
      <section className="w-full py-10 sm:py-14 bg-white border-b border-purple-100">
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-purple-100 p-8 rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center group"
              >
      ...
      <section className="w-full py-10 sm:py-14 bg-purple-100">
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-purple-500 font-medium text-xs mb-1">{testimonial.role}</p>
      ...
      {/* Footer */}
      <footer className="bg-purple-200 text-gray-700 py-8 w-full border-t border-purple-300 mt-auto">
        <div className="w-full max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            ...
            <span className="font-bold text-purple-600 text-lg">FINSPIRE</span>
          </div>
          <div className="flex flex-col items-center md:items-end gap-2">
            <div className="flex space-x-4 mb-1">
              <a href="mailto:contact@finspire.com" className="hover:text-purple-500 transition" title="Contact Us">
              ...
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-500 transition" title="Twitter">
              ...
              <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-500 transition" title="LinkedIn">
              ...
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="hover:text-purple-500 transition" title="Instagram">
